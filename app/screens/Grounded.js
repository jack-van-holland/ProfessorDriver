    ...
    render() {
        return (
            <View style={{ flex: 1, }}>
                ...
                <Text style={[styles.subtitle, { paddingTop: 300, flex: 0.25, alignItems:"center" }]}>Suspend your student's driving privileges to teach them to focus on safe driving and give them time to reflect.</Text>
                <Text style={[styles.subtitle, { flex: 0, alignItems:"center" }]}>Set the date when they will regain their driving privileges.</Text>
         ...
         value={this.state.date} onChange={(event, date) => {this.setState({date: date});}} style={{flex: .25, marginLeft: Dimensions.get("window").width / 2 - 100}}>
                ...
                <View style={{ flex: 1, flexDirection: "row", top: Dimensions.get("window").height - 575}}>
                    ...
                    <View style={{ flex: 1, alignItems: "center" }}>
                        <TouchableHighlight onPress={() => { this.createGrounded(); }}
                            style={styles.nextButtonSelected}
                        >
                            <Text style={styles.nexttext}>Suspend</Text>
                        </TouchableHighlight>
                    </View>
                </View>
            </View>);
